...
<section id="about-anchor" class="d-flex about bg-black">
    <div class="d-flex section-container">
        <img class="about-img"
            src="<?php echo site_url(); ?>/wp-content/themes/benmiles/assets/images/about-ben-niles.webp"
            ...
            <div class="d-flex carousel-container">
                ...
                if ($blog_query->have_posts()):
                    while ($blog_query->have_posts()):
                        ...
                        ?>
                        <article data-item="<?php echo $item_index; ?>"
                            class="d-flex carousel-item <?php echo $active_class; ?>"

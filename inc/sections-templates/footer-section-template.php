footer id="contact-anchor" class=" d-flex bg-black contact">
    ...
    <div class="d-flex footer-navigation">
        ...
        <div class="d-flex email-address">
            ...
            <p class="paragraph-1"><a href="mailto:<?php echo esc_attr(get_theme_mod('benmiles_email', 'benmilespodcast@gmail.com')); ?>"><?php echo esc_html(get_theme_mod('benmiles_email', 'benmilespodcast@gmail.com')); ?></a></p>
            <h4 class="heading-4">Address</h4>
            <p class="paragraph-1"><?php echo esc_html(get_theme_mod('benmiles_address', '2004 HARBOUR GATES DR APT 85 ANNAPOLIS MD 21401-5348 USA')); ?></p>
        </div>
        <div class="d-flex">
            <h4 class="heading-4">Phone Number</h4>
            <p class="paragraph-1"><a href="tel:<?php echo esc_attr(get_theme_mod('benmiles_phone', '+18005559473')); ?>"><?php echo esc_html(get_theme_mod('benmiles_phone', '+1 (800) 555-9473')); ?></a></p>
        </div>
        ...
        <div class="d-flex about-podcast">
            ...
            <div class="d-flex social-links-container">
                ...
                ?>
                <?php if ($facebook_url): ?>
                    <a href="<?php echo esc_url($facebook_url); ?>" class="icon img-icon-54"><img src="<?php echo site_url(); ?>/wp-content/themes/benmiles/assets/icons/facebook.svg" alt="Facebook"></a>
                <?php endif; ?>
                <?php if ($spotify_url): ?>
                    <a href="<?php echo esc_url($spotify_url); ?>" class="icon img-icon-54"><img src="<?php echo site_url(); ?>/wp-content/themes/benmiles/assets/icons/spotify.svg" alt="Spotify"></a>
                <?php endif; ?>
                <?php if ($instagram_url): ?>
                    <a href="<?php echo esc_url($instagram_url); ?>" class="icon img-icon-54"><img src="<?php echo site_url(); ?>/wp-content/themes/benmiles/assets/icons/instagram.svg" alt="Instagram"></a>
                <?php endif; ?>
                <?php if ($twitter_url): ?>
                    <a href="<?php echo esc_url($twitter_url); ?>" class="icon img-icon-54"><img src="<?php echo site_url(); ?>/wp-content/themes/benmiles/assets/icons/twitter.svg" alt="Twitter"></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
